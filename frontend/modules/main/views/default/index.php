    ...
    <div class="searchbar">
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-6">
          <?= Html::textInput('propert', '', ['class' => 'form-control', 'placeholder' => 'Search of Properties']); ?>
          <div class="row">
      ...
      <?php foreach($featured as $row): ?>
        <div class="properties">
          <div class="image-holder">
            ...
            <div class="status <?=strtolower(Common::getType($row)) ?>"><?=Common::getType($row)?></div>
          </div>
          ...
          <div class="listing-detail">
            ...
            ?>
            <?php foreach ($spanarray001 as $k => $v): ?>
          ...
          <div class="carousel-inner">
            ...
            <div class="item <?= $k == 0 ? 'active' : '' ?>">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h5>
                    <a href="<?= Common::getUrlAdvert($row) ?>" ><?=Common::getTitleAdvert($rec) ?></a>
                  </h5>
                  <p class="price">$<?= number_format($rec['price']) ?></p>
                  <a href="<?= Common::getUrlAdvert($row) ?>" class="more">More Detail</a>
                </div>
              </div>
            </div>
            <?php endforeach; ?>
